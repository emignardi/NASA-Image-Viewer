...
/**
 * This class/activity is used for representing the Home page and the entrypoint for the application.
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
     ...
     * SharedPreferences is used as a way to store the current users' name and a SharedPreferences.Editor is used to modify the stored content.
     * When the user restarts the application and returns to this page, a personal greeting will be displayed.
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Welcome back " + sharedPreferences.getString("user", "") + "!");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.home){
            ...
            builder.setTitle(R.string.homeHelpTitle).setMessage("This is the Home screen and entry point for the application. Enter in your name and you will be greeted upon reopening the application.")
